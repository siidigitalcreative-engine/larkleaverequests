...
export default function UndertimeReviewPage() {
  const params =
    useParams<{
      recordId: string;
    }>();
  ...
  const [
    ...
    useState<UndertimeRequest | null>(
      null,
    );
  ...
  useEffect(() => {
    fetch(
      `/api/review/undertime/${encodeURIComponent(
        params.recordId,
  ...
  async function submit(
    ...
    try {
      ...
      setMessage(
        `Undertime request ${data.decision.toLowerCase()}.`,
      );
              ...
              {requestData.status !==
                ...
                >
                  ...
                  <p className="muted">
                    {decision ===
                    "approve"
                      ? "Confirm that you want to approve this Undertime request."
                      : "Enter the reason for rejecting this Undertime request."}
                  </p>
